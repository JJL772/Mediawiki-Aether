  ...
  <footer id="kFooter" class="footer d-print-none">
    ...
    <section id="kLinks" class="container">
      <div class="row">
        ...
        <nav class="col-sm">
          <h3>Develop</h3>
          <a href="https://docs.jlorelli.xyz/">Documentation</a>
          <a href="https://git.jlorelli.xyz/">Git Mirrors</a>
          <a href="https://gitlab.jlorelli.xyz/" target="_blank">Internal GitLab</a>
        </nav>
        <nav class="col-sm">
          <h3>Other Links</h3>
          <a href="https://www.jlorelli.xyz/">Main Website</a>
          <a href="https://www.github.com/JJL772/">GitHub</a>
        </nav>
      </div>
    </section>
    <section id="kLegal" class="container">
      <div class="row">
        <small class="col-4">
          Maintained by <a href="mailto:jeremy.lorelli.1337@gmail.com">Jeremy Lorelli</a>
        </small>
      </div>
    </section>
  </footer>
